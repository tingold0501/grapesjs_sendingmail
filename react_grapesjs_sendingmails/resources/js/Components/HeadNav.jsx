                            ...
                            <ul className="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                                ...
                                <li className="flex items-center">
                                    <a
                                        ...
                                        className="flex block px-0 py-2 text-sm font-semibold transition-all ease-nav-brand text-slate-500"
                                    >
                                        ...
                                        <li className="relative mb-2">
                                            ...
                                            >
                                                <div className="flex py-1">
                                                    <div className="my-auto">
                                                        <img
                                                            src="/images/img/small-logos/logo-spotify.svg"
                    ...
                    <div className="flex flex-wrap mt-6 -mx-3">
                                    ...
                                    <div className="flex flex-wrap -mx-3">
                                        <div className="max-w-full px-3 lg:w-1/2 lg:flex-none">
                                            <div className="flex flex-col h-full">
                                                ...
                                                <p className="mb-12">
                                                    From colors, cards,
                                                    typography to complex
                                                    elements, you will find the
                                                    full documentation.
                                                </p>
                                                <a
                                        ...
                                        <div className="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                                            <div className="h-full bg-gradient-to-tl from-purple-700 to-pink-500 rounded-xl">
                                                <img
                                                    src="/images/img/shapes/waves-white.svg"
                                                ...
                                                <div className="relative flex items-center justify-center h-full">
                                                    <img
                                                        ...
                                                        src="/images/img/illustrations/rocket-white.png"
                                                        alt="rocket"
                                                    />
                                                </div>
                                            </div>
                        ...
                        <div className="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
                            <div className="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
                                <div
                                    className="relative h-full overflow-hidden bg-cover rounded-xl background-image: url('/images/img/ivancik.jpg')"
                                    // style="background-image: url('/images/img/ivancik.jpg')"
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col flex-auto h-full p-4">
                                        ...
                                        <p className="text-white">
                                            ...
                                            about who take the opportunity
                                            first.
                                        </p>
                                        <a
                                                ...
                                                <tr>
                                                    <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                        <div className="flex px-2 py-1">
                                                            <div>
                                                                <img
                                                                    src="/images/img/small-logos/logo-xd.svg"
                                                ...
                                                <tr>
                                                    <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                        <div className="flex px-2 py-1">
                                                            <div>
                                                                <img
                                                                    src="/images/img/small-logos/logo-atlassian.svg"
                                                                    className="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                                                    alt="atlassian"
                                                                />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                        <div className="flex px-2 py-1">
                                                            <div>
                                                                <img
                                                                    src="/images/img/small-logos/logo-slack.svg"
                                                                    className="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                                                    alt="team7"
                                                                />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                        <div className="flex px-2 py-1">
                                                            <div>
                                                                <img
                                                                    src="/images/img/small-logos/logo-jira.svg"
                                                                    className="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                                                    alt="jira"
                                                                />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td className="p-2 align-middle bg-transparent border-0 whitespace-nowrap">
                                                        <div className="flex px-2 py-1">
                                                            <div>
                                                                <img
                                                                    src="/images/img/small-logos/logo-invision.svg"
                                                                    className="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                                                    alt="invision"
                                                                />
                                                            </div>
